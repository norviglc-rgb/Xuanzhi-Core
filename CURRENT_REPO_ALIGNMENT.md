...
| 文件 | 当前状态 | 所属基线 | 主要问题 | 处理动作 | 优先级 |
|---|---|---:|---|---|---:|
| `CURRENT_WORKSPACE_STATUS.md` | 过时 | 阶段推进 / 现状说明 | 与当前 repo 现实存在冲突 | 不作事实源，仅作阶段参考 | P0 |
...
- **质量门禁**：目前隐含在 red lines / risk / state / memory policy 中，需正式集中定义
...
- 更新 glossary / architecture / README / tools / integrations
